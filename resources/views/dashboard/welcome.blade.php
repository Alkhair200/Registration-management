            ...
            <div class="row">
                ...
                {{-- <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-green">
                        <div class="inner">
                            ...
                            <p>@lang('site.slider')</p>
                        </div>
                        <div class="icon">
                            <i class="fa fa-users"></i>
                        </div>
                        <a href="{{ route('dashboard.sliders.index') }}" class="small-box-footer">@lang('site.read') <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div> --}}
                {{--contacts--}}
                {{-- <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-blue">
                        <div class="inner">
                            ...
                            <p>@lang('site.contact')</p>
                        </div>
                        <div class="icon">
                            <i class="fa fa-users"></i>
                        </div>
                        <a href="{{ route('dashboard.contact.index') }}" class="small-box-footer">@lang('site.read') <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div> --}}
                ...
                {{-- <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-blue">
                        ...
                        <a href="{{ route('dashboard.about_us.index') }}" class="small-box-footer">@lang('site.read') <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div> --}}
            </div><!-- end of row -->
